...
/**
 * Properties for the EmotionBadge component.
 * Validates a sentiment string to automatically extract the mapped styling and visual icon.
 */
 ...
 * A stylized visual label that maps natural language sentiments (like "Happiness" or "Fear")
 * to predefined Lucide icons and Tailwind CSS color schemas. Displays an optional confidence score.
 */
